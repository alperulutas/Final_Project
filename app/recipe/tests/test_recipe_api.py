...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='test9@example.com', password='test12345')
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        new_user = create_user(email='tes6@example.com', password='test123123')
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 10,
            'price': Decimal('3.50'),
            'tags': [{'name': 'Fast Food'}, {'name': 'Sandwich'}]
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('19.90'),
            'tags': [{'name': 'Italian'}, {'name': 'Pizza'}, {'name': 'Fast Food'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_tag(self):
        ...
        tag_cocktail = Tag.objects.create(user=self.user, name='Cocktail')
        recipe = create_recipe(user=self.user)
        recipe.tags.add(tag_cocktail)
        ...
        self.assertNotIn(tag_cocktail, recipe.tags.all())
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Brown Sugar'}, {'name': 'Vanilla'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('19.90'),
            'ingredients': [{'name': 'Mushroom'}, {'name': 'Sausage'}, {'name': 'Tomato'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_soda = Ingredient.objects.create(user=self.user, name='Soda')
        payload = {'ingredients': [{'name': 'Soda'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Fettucini Alfredo')
        recipe2 = create_recipe(user=self.user, title='Margherita Pizza')
        tag1 = Tag.objects.create(user=self.user, name='Pasta')
        tag2 = Tag.objects.create(user=self.user, name='Fast FOod')
    ...
    def test_filter_by_ingredients(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Hamburger')
        recipe2 = create_recipe(user=self.user, title='Tiramisu')
        ingredient1 = Ingredient.objects.create(user=self.user, name='Mushroom')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Espresso')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = create_recipe(user=self.user, title='Sushi')
